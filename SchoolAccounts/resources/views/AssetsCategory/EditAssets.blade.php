            ...
            <div class="col-xl-12 col-xxl-12">
                ...
                <div class="card col-6 d-flex m-auto justify-content-center">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Edit Assets Category</h4>
                    </div>

                    <div class="card-body">
                        <div class="basic-form">

                            <form method="post" action="{{ route('UpdateAssetsCategories', $AssetsCategory->UniqueCode) }}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <label class="sr-only">Admit Expense</label>
                                        <input type="text" class="form-control mb-2 admitClass" name="Expensecategory"
                                            placeholder="Admit Expense" value="{{ $AssetsCategory->CategoryName }}" required>
                                    </div>
