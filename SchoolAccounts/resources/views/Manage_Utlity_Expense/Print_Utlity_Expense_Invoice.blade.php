  ...
  <div class="invoice-container" ref="document" id="html">
     ...
     <table style="width:100%; height:auto;  text-align:center; " BORDER=0 CELLSPACING=0>
       <thead style="background:#fafafa; padding:8px;">
         <tr style="font-size: 20px;">
           <td colspan="4" style="padding:20px 20px;text-align: left;">Expense Invoice</td>
         </tr>
       </thead>
       <tbody style="background:#ffff;padding:20px;">
         <tr>
           <td colspan="4" style="padding:20px 0px 00px 20px;text-align:left;font-size: 16px; font-weight: bold;color:#000; text-transform: uppercase;">{{ $AcademyDetails->Name }}</td>
         </tr>
         <!-- <tr>
     ...
     <table style="width:100%; height:auto; background-color:#fff;text-align:center; padding:10px; background:#fafafa">
       <tbody>
         ...
         <tr style="background-color:#fff; font-size:12px; color:#262626;">
           <td style="border-right:1.5px dashed  #DCDCDC ;width:25%; font-weight:bold;background: #fafafa;">{{ $ManageUtlityExpense->Date }}</td>
           <td style="border-right:1.5px dashed  #DCDCDC ;width:25% ; font-weight:bold;background: #fafafa;">{{ $ManageUtlityExpense->id }}</td>
    ...
    <!-- End Invoice details side -->
     ...
     <table style="width:100%; height:auto; background-color:#fff; margin-top:0px;  padding:20px; font-size:12px; border: 1px solid #ebebeb; border-top:0px;">
       ...
       <tbody>
         <tr>
           <td style="width:30%; ">{{ $ManageUtlityExpense->ExpenseName }}</td>
           <td style="width:30%;padding: 10px; text-align:center;">{{ $ManageUtlityExpense->BankName. ' - ' .$ManageUtlityExpense->BankTitle  }}</td>
           <td style="width:30%;padding: 10px;text-align: center;">{{ $ManageUtlityExpense->Description }}</td>
           <td style="text-align:end;font-size:13px; width:30%;padding: 10px;text-align: end;">{{ $ManageUtlityExpense->Amount }}</td>
         </tr>
       </tbody>
     </table>
     <!-- end content table -->
     ...
     <table style="width:100%; height:auto; background-color:#fff;padding:20px; font-size:12px; border: 1px solid #ebebeb; border-top:0">
       <tbody>
         <tr style="padding:20px;color:#000;font-size:15px">
           ...
           <td style="text-align:right;padding:5px 0px;font-weight: bold;font-size:16px;">{{ $ManageUtlityExpense->Amount }}</td>
         </tr>
