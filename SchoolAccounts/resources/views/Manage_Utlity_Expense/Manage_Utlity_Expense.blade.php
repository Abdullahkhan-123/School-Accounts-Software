                ...
                <div class="card col-6 d-flex m-auto justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <form method="post" action="{{ route('SaveManageUtlityExpense') }}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row"> 
                                    <div class="col">
                                        ...
                                        <select class="form-control" name="ExpenseCategory" id="sel1" required>
                                            ...
                                            @foreach($UtlityExpense as $UtlityExpense)
                                                <option value="{{ $UtlityExpense->id }}">{{ $UtlityExpense->CategoryName}}</option>
                                            @endforeach
