                ...
                <div class="card col-6 d-flex m-auto justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <form method="post" action="{{ route('UpdateUtlityExpenseCategory', $UtlityExpenseCategory->UniqueCode) }}">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <label class="sr-only">Admit Expense</label>
                                        <input type="text" class="form-control mb-2 admitClass" name="Expensecategory"
                                            placeholder="Admit Expense" value="{{ $UtlityExpenseCategory->CategoryName }}" required>
                                    </div>
