                ...
                <div class="card col-6 d-flex m-auto justify-content-center">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <form method="post" action="{{ route('SaveClasses') }}" id="addClassForm">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="sr-only">Admit Class</label>
                                        <input type="text" class="form-control mb-2 admitClass" name="AdmitClass[]"
                                            placeholder="Admit Class" required>
                                    </div>
...
<script>
        document.addEventListener('DOMContentLoaded', function () {
            document.getElementById('addMoreFields').addEventListener('click', function () {
                ...
                input.name = 'AdmitClass[]';
                input.placeholder = 'Admit Class';
